...
function Onepage() {
  return (
    <div className="w-full h-[600px] backdrop-blur-2xl rounded-xl shadow-2xl shadow-black/30 flex flex-col md:flex-row items-center justify-around p-12 mt-12 gap-6">
